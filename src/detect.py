...
if  run_saved_model:
    ...
    if use_mobile_net:
        history_mobile = tf.saved_model.load('./models/mobilenet/1')
    if use_res_net:
        history_resnet = tf.saved_model.load('./models/resnet/1')
    if use_dense_net:
        history_densenet = tf.saved_model.load('./models/densenet/1')
if use_mobile_net:
